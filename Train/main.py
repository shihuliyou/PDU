    ...
    def train(self):
        ...
        for i in range(self.epochs):
            ...
            with torch.no_grad():
                ...
                print(
                    '\t Valid performance:',
                    'sharpe1:', cur_valid_perf['sharpe1'],
                    'sharpe10:', cur_valid_perf['sharpe10'],
                    'sharpe5_max:', cur_valid_perf['sharpe5_max'],
                    'realndcg5:', cur_valid_perf['realndcg5'],
                    'ndcg_score_top5(last day):', cur_valid_perf['ndcg_score_top5'],
                    'mse:', cur_valid_perf['mse'],
                )
            ...
            print(
                '\t Test performance:',
                'sharpe1:', cur_test_perf['sharpe1'],
                'sharpe10:', cur_test_perf['sharpe10'],
                'sharpe5_max:', cur_test_perf['sharpe5_max'],
                'realndcg5:', cur_test_perf['realndcg5'],
                'ndcg_score_top5(last day):', cur_test_perf['ndcg_score_top5'],
                'mse:', cur_test_perf['mse']
            )
